...
namespace ReferenceCop
{
    internal static class DiagnosticFactory
    {
        ...
        public static Diagnostic CreateDiscouragedReferenceDiagnosticFor(string referenceName)
        {
            return Diagnostic.Create(DiagnosticDescriptors.DiscouragedReferenceRule, Location.None, referenceName);
        }
